...
>[!NOTE]
>
>Einige PHP-Erweiterungen weisen umgebungsspezifische Installationsbeschränkungen auf und werden in der obigen Tabelle nicht vollständig dargestellt. [!DNL LDAP] kann beispielsweise in Integrationsumgebungen über die Projektkonfiguration aktiviert werden, es handelt sich jedoch nicht um eine Self-Service-Konfiguration für Pro Staging und Produktion über `.magento.app.yaml`.
