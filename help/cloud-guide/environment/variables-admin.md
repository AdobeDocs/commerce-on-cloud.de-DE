...
Standardmäßig ist die URL für [Commerce Admin](https://experienceleague.adobe.com/docs/commerce-admin/start/admin/admin.html) auf *&lt;domain_name>/admin* festgelegt. Aus Sicherheitsgründen empfiehlt Adobe, sie in eine eindeutige, benutzerdefinierte Admin-URL zu ändern, die nicht einfach zu erraten ist.
