...
1. Aktualisieren Sie die Basis-URL.
   ...
   **HINWEIS**: Sie können die Basis-URL auch über den Administrator aktualisieren. Siehe [Store-URLs](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/site-store/store-urls) im _Handbuch zu Adobe Commerce Stores und Kauferlebnissen_.
