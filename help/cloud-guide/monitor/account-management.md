...
Wenn der Lizenzinhaber geändert wurde und der neue Lizenzinhaber derzeit keinen Zugriff auf New Relic hat, [&#x200B; Sie ein Adobe Commerce-Support-Ticket &#x200B;](https://experienceleague.adobe.com/de/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket).
...
1. Klicken Sie auf **[!UICONTROL Administration]** und wählen Sie eine der folgenden Optionen aus der Liste aus:
   ...
   - **[!UICONTROL User management]** Sie Benutzer hinzufügen, aktive Benutzer und ausstehende Einladungen verwalten und Benutzer entfernen oder deaktivieren, die den Zugriff nicht mehr benötigen, z. B. Benutzer, die Ihr Unternehmen verlassen haben.
...
>- Anmeldedaten für den Zugriff auf [Admin](https://experienceleague.adobe.com/de/docs/commerce-admin/systems/user-accounts/permissions) für die Umgebung
...
1. Fügen Sie den New Relic-Lizenzschlüssel mithilfe der `magento-cloud` CLI einer Umgebung hinzu.
   ...
   Optional können Sie es über die [Commerce Admin](https://experienceleague.adobe.com/de/docs/commerce-on-cloud/user-guide/monitor/new-relic/new-relic-service) hinzufügen.
...
3. **Benötigen Sie Hilfe?** Wenn kein bestehender Eigentümer oder Administrator behilflich sein kann, kann jeder Adobe Commerce-Benutzer mit Zugriff auf das [Adobe Commerce](https://account.newrelic.com/accounts/1311131/users)Partnerkonto Benutzer in Ihrem Namen hinzufügen.

Weitere Informationen finden Sie in der Übersicht über den [New Relic-Service](https://experienceleague.adobe.com/de/docs/commerce-on-cloud/user-guide/monitor/new-relic/new-relic-service).
