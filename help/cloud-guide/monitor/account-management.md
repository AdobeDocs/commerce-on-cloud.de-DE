...
>- Anmeldedaten für den Zugriff auf [Admin](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/user-accounts/permissions) für die Umgebung
...
1. Fügen Sie den New Relic-Lizenzschlüssel mithilfe der `magento-cloud` CLI einer Umgebung hinzu.
   ...
   Optional können Sie es über die [Commerce Admin](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/monitor/new-relic/new-relic-service) hinzufügen.
...
Weitere Informationen finden Sie in der Übersicht über den [New Relic-Service](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/monitor/new-relic/new-relic-service).
