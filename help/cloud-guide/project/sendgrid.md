...
Um Ihre E-Mail-Versandeinstellungen besser zu verwalten, verwenden Sie Ihren eigenen [SMTP-Server oder E-Mail-Versanddienstleister](https://experienceleague.adobe.com/de/docs/commerce-admin/systems/communications/email-communications). Sie können sich auch für Ihren eigenen SendGrid-Service anmelden, um dem Cloud-Service-Stack genau zu folgen.
