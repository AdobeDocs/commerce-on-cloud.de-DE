...
Um Ihre E-Mail-Versandeinstellungen besser zu verwalten, verwenden Sie Ihren eigenen [SMTP-Server oder E-Mail-Versanddienstleister](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/communications/email-communications). Sie können sich auch für Ihren eigenen SendGrid-Service anmelden, um dem Cloud-Service-Stack genau zu folgen.

>[!IMPORTANT]
>
>Wenn Sie Ihr eigenes SendGrid-Konto verwenden, erhalten Sie keine SendGrid-Unterstützung mehr über Adobe.
>
>Um Ihren proprietären SendGrid-Service zu aktivieren oder einen vorhandenen API-Schlüssel zu aktualisieren, [ Sie (ein Adobe Commerce-Support-Ticket ](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket)) den API-Schlüssel für Ihr SendGrid-Konto ein.
...
>[!WARNING]
>
>Die Unterstützung der SendGrid-DKIM-Signaturen und der Domain-Authentifizierung ist nur in der Produktions- und Staging-Umgebung für Pro-Projekte verfügbar. Sie werden in Starter-Umgebungen nicht unterstützt.
>
>Aus diesem Grund sind von Starter-Umgebungen gesendete Transaktions-E-Mails mit höherer Wahrscheinlichkeit als Spam gekennzeichnet, da sie nicht vollständig authentifiziert werden können.  In Pro-Umgebungen wird Ihre Versand-Domain durch die Aktivierung von DKIM authentifiziert, was die Zustellbarkeit von E-Mails erheblich verbessert und die Wahrscheinlichkeit verringert, dass Nachrichten als Spam gefiltert werden.
>
>Um die Nachrichtenversand-Rate zu verbessern, führen Sie ein Upgrade von Starter auf Pro durch oder verwenden Sie Ihren eigenen SMTP-Server oder E-Mail-Versanddienstleister. Siehe [Konfigurieren von E-Mail](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/communications/email-communications)-Verbindungen im _Handbuch für Admin-Systeme_.
...
1. Senden Sie ein [Support-Ticket](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket), um die Aktivierung von DKIM für eine bestimmte Domain anzufordern (**nur Pro Staging- und Produktionsumgebungen**).
...
1. Überprüfen Sie die `/var/log/mail.log` auf `authentication failed : Maxium credits exceeded` Einträge.
   ...
   Wenn `authentication failed` Protokolleinträge angezeigt werden und die **E-Mail-**) mindestens 95 beträgt, können Sie [Adobe Commerce-Support-Ticket einreichen](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) um eine Erhöhung der Kreditzuteilung anzufordern.
...
Wenn einige Empfänger Ihre E-Mails nicht erhalten, können [ein Adobe Commerce-Support-Ticket ](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket), um eine Überprüfung der Unterdrückungslisten anzufordern und die Empfänger bei Bedarf zu entfernen.
