...
- ![Fehlerbehebungssymbol](../../assets/fix.svg) **Sicherheitsverbesserungen**-Angewandte Sicherheitskorrekturen, auf die in [Adobe Commerce-Sicherheitsupdate APSB26-92 verwiesen wird](https://helpx.adobe.com/security/products/magento/apsb26-92.html).<!--MCLOUD-15035 -->
...
- ![Fehlerbehebungssymbol](../../assets/fix.svg) **Sicherheitsverbesserungen**-Angewandte Sicherheitskorrekturen, auf die in [Adobe Commerce-Sicherheitsupdate APSB26-73 verwiesen wird](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-37421).<!--MCLOUD-15066 -->
...
- ![Fix icon](../../assets/fix.svg) **Patch** - Fehlerbehebung für den [Checkout schlägt fehl, wenn JS-Minimierung und -Bundle aktiviert sind](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997) Problem in der *Commerce Knowledgebase*.
