...
- ![Fix icon](../../assets/fix.svg) **Patch** - Fehlerbehebung für das Problem [Checkout schlägt fehl, wenn JS-Minimierung und -Bundling aktiviert sind](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997)), das in der *Commerce Knowledgebase“ (Tickets AC-15867 und ACSD-68617) beschrieben wird.<!-- MCLOUD-14191 -->
