...
- ![neues Symbol](../../assets/new.svg) **RabbitMQ** - Unterstützung für RabbitMQ 4.3 hinzugefügt.<!-- MCLOUD-15088 -->
- ![Fix icon](../../assets/fix.svg) **Redis Lua Configuration** - `USE_LUA_ON_GC` Unterstützung und veraltete `LUA_KEY` hinzugefügt.<!-- MCLOUD-15048 -->
- ![fix icon](../../assets/fix.svg) **Symfony L2 cache**-Fixed ece-tools Kompatibilität mit der Adobe Commerce 2.4.9 Cache Konfiguration<!-- MCLOUD-15114 -->

## v2002.2.11

Veröffentlichungsdatum: 6. Mai 2026

- ![neues Symbol](../../assets/new.svg) **RabbitMQ** - Unterstützung für RabbitMQ 4.2 hinzugefügt.<!-- MCLOUD-14374 -->
- ![neues Symbol](../../assets/new.svg) **OpenSearch**—Es wurde Unterstützung für OpenSearch 2.19 und 3.5 für mehrere Magento-Versionen hinzugefügt. <!-- MCLOUD-14682 -->
- ![neues Symbol](../../assets/new.svg) **Valkey** - Unterstützung für Valkey 8.1 und 9 wurde hinzugefügt.<!-- MCLOUD-14784/MCLOUD-14625 -->
- ![neues Symbol](../../assets/new.svg) **ActiveMQ** - Unterstützung für ActiveMQ 2.5.1 wurde hinzugefügt.<!-- MCLOUD-14683 -->
- ![neues Symbol](../../assets/new.svg) **MariaDB** - Unterstützung für MariaDB 11.8 und 12.2 hinzugefügt.<!-- MCLOUD-14628 -->
- ![Fix icon](../../assets/fix.svg) **Configuration and deployment**: Behobene Cloud-Bereitstellungswarnungen, aktualisierte Composer-Testveraltungen und korrigierte Sichtbarkeit der ECE-Tools bei der Bereitstellung.<!-- MCLOUD-14822 -->

## v2002.2.10

Veröffentlichungsdatum: 5. März 2026

- ![neues Symbol](../../assets/new.svg) **PHP 8.5**—Unterstützung für PHP 8.5.<!-- MCLOUD-14179 --> hinzugefügt
- ![Fix icon](../../assets/fix.svg) **Aktualisierter Funktionstest** Aktualisierte Valkey 8.1-, 8,2- und Redis 8.4-Tests<!-- MCLOUD-13983 -->
- ![Fix icon](../../assets/fix.svg) **Aktualisiert MariaDB, PHP und OpenSearch-**-Das Validatorskript wurde aktualisiert.<!-- MCLOUD-14574/MCLOUD-14466 -->
...
- ![Fix icon](../../assets/fix.svg) **Cache-Bereinigung für aktive Services wurde**. - Aktive Service-Validierung wurde hinzugefügt.<!-- MCLOUD-14166 -->
...
- ![Fix-Symbol](../../assets/fix.svg) **[!DNL RabbitMQ]Problem mit der neuen Commerce 2.4.5-** - Es wurde [!DNL RabbitMQ] Absturzproblem in der neuen Commerce 2.4.5 behoben. installation.<!-- MCLOUD-9059 -->
