...
>Bei Pro-Staging- und Pro-Produktionsumgebungen müssen Sie [ein Adobe Commerce-Support-Ticket einreichen](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide.html?lang=de#submit-ticket) um Änderungen an der Protokollrotationskonfiguration anzufordern.
