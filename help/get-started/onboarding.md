...
Nachdem Adobe ein Commerce on Cloud Infrastructure-Abonnement aktiviert hat, ist der anfängliche Projekt- und Code-Zugriff nur für die Person verfügbar, die als Lizenzinhaber (Kontoinhaber) festgelegt wurde.

Der Lizenzinhaber ist die Person in Ihrem Unternehmen oder Ihrer Finanzorganisation, die Zahlungen und andere geschäftliche Transaktionen für das Adobe Commerce on Cloud Infrastructure-Konto verwaltet. Diese Person dient als Ansprechpartner für Adobe. Wenn Sie den Lizenzinhaber für Ihr Konto ändern müssen, müssen Sie sich an Ihr Adobe-Accountteam wenden.
